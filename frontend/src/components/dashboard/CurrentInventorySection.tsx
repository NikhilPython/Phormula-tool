...
// //   const companyNameForExcel = useMemo(
// //     () => capitalizeWords(userData?.company_name || ""),
// //     [userData?.company_name]
// //   );

// //   const brandNameForExcel = useMemo(
// //     () => capitalizeWords(userData?.brand_name || ""),
// //     [userData?.brand_name]
// //   );
...
// // // ✅ early return with UI only (no setState)
// // if (!userData) {
// //   return (
...
// //       filename: fileName,
// //       titleLine: `Amazon ${displayCountry} - Current Inventory - ${periodLabel}`,

// //       countryName: inventoryCountry,     // uk/us/global (lowercase)
// //       titleCountry: displayCountry,      // UK/US/Global
...
// //     // Optional: make headers bold-ish by widening columns (xlsx doesn't style much without pro libs)
// //     // Auto column widths

...
def _normalize_sku_row(row: dict) -> dict:
    ...
    r["gross_sales"] = _to_number(r.get("gross_sales"))
    r["total_quantity"] = _to_number(r.get("total_quantity"))
    r["return_quantity"] = _to_number(r.get("return_quantity"))
    ...
    r["promotional_rebates"] = _to_number(r.get("promotional_rebates"))
    r["promotional_rebates_percentage"] = _to_number(r.get("promotional_rebates_percentage"))
    r["advertising_total"] = _to_number(r.get("advertising_total"))
    r["advertising_total_final"] = _to_number(r.get("advertising_total_final"))
    r["platform_fee"] = _to_number(r.get("platform_fee"))
    ...
    r["cm2_profit"] = _to_number(r.get("cm2_profit"))
    r["cm2_profit_total"] = _to_number(r.get("cm2_profit_total"))
    r["cm2_margins"] = _to_number(r.get("cm2_margins"))
    r["cm2_profit_percentage"] = _to_number(r.get("cm2_profit_percentage"))
    r["cm2_profit_per"] = _to_number(r.get("cm2_profit_per"))
    r["cm2_profit_per_unit"] = _to_number(r.get("cm2_profit_per_unit"))

...
// type Provider = "amazon" | "shopify" | "amazon_ads"; // ✅ add
...
//   { key: "amazon", title: "Amazon", icon: "/amazon.png" },
//   { key: "shopify", title: "Shopify", icon: "/shopify.png" },
//   { key: "amazon_ads", title: "Amazon Ads", icon: "/amazon-ads.png" }, // ✅ add
// ];
...
//   //   // ✅ MUST include origin:"header" (your HeaderIntegrationFlow requires it)
//   //   window.dispatchEvent(
//   //     new CustomEvent("integration:choose", {
...
//       return; // DON'T close the modal yet (optional)
//     }
...
//   useEffect(() => {
//     const test = (e: any) => console.log("Modal heard integration:choose", e.detail);
...
const options: { key: Provider; title: string; icon: string }[] = [
  { key: "amazon", title: "Amazon", icon: "/amazon.png" },
  { key: "shopify", title: "Shopify", icon: "/shopify.png" },
  { key: "amazon_ads", title: "Amazon Ads", icon: "/amazon-ads.png" },
];
...
const IntegrationsModal: React.FC<Props> = ({ open, onClose, onConnected }) => {
  ...
  const modalContent = (
    ...
    >
      ...
      {/* Modal box */}
      <div
        className="relative z-10 w-full max-w-md rounded-xl border border-gray-200 bg-white px-1 py-7 shadow-2xl dark:border-gray-800 dark:bg-gray-900"
        onClick={(e) => e.stopPropagation()} // ✅ prevents close on button click
      >
        <PageBreadcrumb
          pageTitle="Select Your Integration"
          variant="table"

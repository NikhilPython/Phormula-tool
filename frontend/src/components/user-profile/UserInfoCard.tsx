...
//           const tooltipTitle = document.querySelector(".introjs-tooltip-title");

//           if (tooltipTitle && typeof index === "number") {
//             tooltipTitle.innerHTML = `Step ${index + 1} out of ${introSteps.length}`;
//           }
//         }}
//         options={{
//           showProgress: false,
...
//             if (tooltipText && typeof stepIndex === "number") {
//               const existing = tooltipText.querySelector(".custom-step-counter");

//               if (!existing) {
//                 const counter = document.createElement("div");
//                 counter.className = "custom-step-counter";
//                 counter.style.fontSize = "14px";
//                 counter.style.fontWeight = "600";
//                 counter.style.color = "#414042";
//                 counter.style.marginBottom = "8px";
//                 counter.innerText = `Step ${stepIndex + 1} out of ${introSteps.length}`;

//                 tooltipText.prepend(counter);
//               } else {
//                 existing.textContent = `Step ${stepIndex + 1} out of ${introSteps.length}`;
//               }
//             }
//           });
//         }}
...
//             const targetId =
//               (targetElement as any) instanceof HTMLElement ? `#${(targetElement as HTMLElement).id}` : "";

//             const currentStepIndex = introSteps.findIndex(
//               (step) => step.element === targetId
//             );

//             if (currentStepIndex === -1) return;

//             tooltipTitle.textContent = `Step ${currentStepIndex + 1} of ${introSteps.length}`;
//           });
//         }}
//         options={{
//           showProgress: false,

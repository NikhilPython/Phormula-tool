...
class User(db.Model):
    ...
    password_reset_otp_expires_at = db.Column(db.DateTime(timezone=True), nullable=True)
    password_reset_otp_attempts = db.Column(db.Integer, nullable=False, default=0)
    password_reset_otp_sent_at = db.Column(db.DateTime(timezone=True), nullable=True)

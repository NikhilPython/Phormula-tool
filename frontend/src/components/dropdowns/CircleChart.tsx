...
//     if (isZero) {
//       setDisplayChartData(null); // ✅ show blank instead
//     } else {
...
//   const showPreviewBlank = isDemoMode;
//   const showNoDataState = !isDemoMode && allValuesZero;
//   const showChart = !isDemoMode && !!displayChartData && !!legendModel;
...
//       {/* Chart */}
//       <div
//         className={`flex-1 w-full min-h-[260px] md:min-h-[287px] xl:min-h-[300px] 2xl:min-h-[360px] flex items-center justify-center opacity-100

...
//         BackdropProps: {
//           sx: {
//             backgroundColor: "rgba(0,0,0,0.4)", // match bg-black/40
//           },
//         },
//       }}
//       transitionDuration={250} // match framer motion timing
//       PaperProps={{
//         sx: {
//           height: "100vh",
//           width: {
//             xs: "95vw",   // match RightProductDrawer
//             sm: "75vw",
//             md: "60vw",
//             lg: "50vw",
//             xl: "50vw",
//           },
//           maxWidth: "unset", // remove 900px cap
//           boxShadow: "0 25px 50px -12px rgba(0,0,0,0.25)", // shadow-2xl equivalent
//           borderRadius: 0, // keep edge-to-edge like motion drawer
//           display: "flex",

...
//                             }}
//                             className={`w-full h-11 rounded-md border bg-white px-3 pr-10 text-sm text-gray-800 dark:bg-gray-800 dark:text-gray-200 ${companyTouched.annual_sales_range && companyErrors.annual_sales_range
//                               ? "border-red-500"
//                               : "border-gray-300"
//                               }`}
//                           >
...
//                             }}
//                             className={`w-full h-11 rounded-md border bg-white px-3 pr-10 text-sm text-gray-800 dark:bg-gray-800 dark:text-gray-200 ${companyTouched.homeCurrency && companyErrors.homeCurrency
//                               ? "border-red-500"
//                               : "border-gray-300"
//                               }`}
//                           >
...
export default function UserInfoCard({ activeTab = "personal" }: { activeTab?: ProfileTab }) {
  ...
  const monthlyTargetColumns: ColumnDef<TargetRow>[] = useMemo(
    () => [
      ...
      { key: "marketplace", header: "Marketplace", width: "180px" },
      {
        ...
        render: (row: any) => {
          ...
          if (!isEditing) {
            if (!isTargetEditMode) {
              return <span className="block w-full text-center">{row.targetNative}</span>;
            }
    ...
    [homeCurrencyCode, editingPid, draftTarget, isTargetEditMode]
  );
                        ...
                        isCompanyEditMode ? (
                          <div>
                            <select
                              ...
                              className={`h-11 w-full rounded-md border bg-white px-3 pr-10 text-sm text-gray-800 dark:bg-gray-800 dark:text-gray-200 ${
                                companyTouched.annual_sales_range && companyErrors.annual_sales_range
                                  ? "border-red-500"
                                  : "border-gray-300"
                              }`}
                      ...
                      <div className="col-span-2">
                        ...
                        <p
                          ...
                          className={`cursor-pointer text-sm font-medium ${
                            isSuccess ? "text-green-600 dark:text-green-400" : "text-blue-600 hover:underline"
                          }`}
                        >
                          {isSending
                            ? "Sending..."

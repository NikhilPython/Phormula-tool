...
//       <table
//         className={clsx(
//           // ✅ Safari-friendly sticky header behavior
//           "border-separate border-spacing-0 text-xs 2xl:text-sm text-slate-700",

//           // ✅ Let table become wider than viewport so scroll activates
//           "min-w-max w-max lg:w-full",

//           // ✅ Mobile: auto layout to prevent crushing
//           "table-auto",
...
//                 className={clsx(
//                   // ✅ sticky on TH (Safari/iOS reliable)
//                   stickyHeader && "sticky top-0 z-20",

//                   // ✅ force header background to stay painted
//                   "bg-[#5EA68E] text-yellow-200",

//                   // ✅ don’t allow breaking words into letters
//                   "whitespace-nowrap break-normal",

//                   // ✅ borders that work with border-separate
//                   "border-b border-gray-300 px-2 py-2 text-center align-middle",

//                   // ✅ allow tailwind width tokens if provided
//                   getWidthClass(col),
...
//                 )}
//               >
//                 {/* ✅ Keep your clamp, but do NOT break words */}
//                 <div
//                   className={clsx(
//                     "mx-auto overflow-hidden text-ellipsis",
//                     "[display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:2]"
//                   )}
//                 >
//                   {formatHeader(col.header)}
...
//                       style={getWidthStyle(col)}
//                       className={clsx(
//                         "border-b border-[#e1e5ea] px-2 py-2 align-middle text-center",
//                         "min-w-0",

//                         // ✅ keep text readable; prevent breaking into letters
//                         isTextCol ? "whitespace-normal break-words" : "whitespace-nowrap",
...
//     {/* ✅ Pagination OUTSIDE X-scroll wrapper */}
//     {paginate && totalPages > 1 && (
//       <div className="border-t border-slate-200 bg-slate-50 px-4 py-3">
//         <div className="flex items-center justify-between gap-4 text-[10px] 2xl:text-xs">
//           <button

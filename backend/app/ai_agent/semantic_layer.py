...
SEMANTIC_OVERRIDES: Dict[str, MetricSemantic] = {
    ...
    "cm2_profit": _metric("cm2_profit", "SKU CM2 profit", "margin", "SKU-level CM2 contribution after CM1 profit minus ads and platform fees where allocated to SKU", better_when="up", unit="money", diagnostic_priority=90),
    "total_cm2_profit": _metric("total_cm2_profit", "Account CM2 profit", "margin", "month/account-level CM2 contribution after CM1 profit minus ads and platform fees", better_when="up", unit="money", diagnostic_priority=88),
    "cm2_profit_per": _metric("cm2_profit_per", "CM2 margin", "margin", "CM2 profit as a percentage of sales", better_when="up", unit="percentage", queryable=False, diagnostic_priority=84),

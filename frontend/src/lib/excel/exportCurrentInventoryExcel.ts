...
//   // ✅ Summary block (shown in UI) to be appended at the bottom of the export
...
// // fallback → last column if CM1 Profit not found
// const ANCHOR_COL_1_BASED =
//   cm1ProfitCol0 >= 0 ? cm1ProfitCol0 + 1 : headerCount;
...
//   // =========================
//   // Summary rows aligned to:
//   //  - titles under "Product Name"
//   //  - values under "CM1 Profit"
//   // =========================
...
//   // If n is 22.48, treat as 22.48% -> 0.2248 for Excel percent
//   // If n is 0.2248 already, keep it
//   row[valueCol] = n > 1 ? n / 100 : n;
// } else {
//   row[valueCol] = n;
// }
...
//     - blank row
//     - "Summary" title row
//     - summaryRows.length data rows
//   */

//   const firstSummaryRow =
//     topAoA.length +        // top block
//     1 +                    // header row
//     bodyAoA.length +       // data rows
//     1;                     // blank separator

//   const summaryRowCount = 1 + summaryRows.length; // title + items
...
// // =========================
// // Force all numeric cells to 2 decimal places
// // =========================
...
// // Must run AFTER the global 2-dec loop
// // =========================
// if (summaryRows?.length) {
//   const firstSummaryRow =
//     topAoA.length + 1 + bodyAoA.length + 1; // same as your bold-summary section

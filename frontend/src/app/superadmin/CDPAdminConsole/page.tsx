    ...
    <div className="min-h-[100svh] flex items-center justify-center px-4 py-6 sm:px-6 lg:px-8 font-sans bg-[#5EA68E]">
      <div className="w-full max-w-sm sm:max-w-md md:max-w-lg rounded-2xl bg-white/95 shadow-2xl backdrop-blur px-6 py-7 sm:px-8 sm:py-9 md:px-10 md:py-10">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-r from-[#5EA68E] to-[#1f5274] mb-3 sm:mb-4">
        ...
        <button
          ...
          onClick={handleLogin}
          disabled={isLoading}
          className="w-full inline-flex items-center justify-center gap-2 py-2.5 sm:py-3 px-4 text-sm sm:text-base font-semibold text-white rounded-lg bg-gradient-to-r from-[#5EA68E] to-[#1f5274] transition disabled:opacity-50 disabled:cursor-not-allowed hover:scale-[1.02]"
        >

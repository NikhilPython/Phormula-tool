...
//   const columns = originalColumns.filter((col) => !EXCEL_EXCLUDED_COLUMNS.has(col));
...
//   // 3️⃣ Currency / Country / Platform (Dropdowns starts from index 3)

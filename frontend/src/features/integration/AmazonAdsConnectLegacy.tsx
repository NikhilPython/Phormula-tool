...
// const ICONS = {
//   amazonAdsLogo: "/amazon-ads.png", // add this asset
...
// export default function AmazonAdsConnectLegacy({ onClose, onConnected }: Props) {
...
//     try {
//       const s = await api(`/amazon_ads_api/status`);
...
//     try {
//       const data = await api(`/amazon_ads_api/login`);
...
//       if (!authUrl) throw new Error("Failed to get Amazon Ads login URL");

//       const w = window.open(authUrl, "amazon_ads_oauth", "width=720,height=800");
...
//       if ((data as any).type === "amazon_ads_oauth_success") {
//         try {
...
//       if ((data as any).type === "amazon_ads_oauth_error") {
//         stopPolling();
//         closePopup();
//         setError((data as any).error || "Amazon Ads connection failed.");
//       }
//     };
...
//           Sync your Amazon Ads data to access campaign analytics and spend insights
//         </p>
...
//             {[
//               "Campaign spend & performance sync",
